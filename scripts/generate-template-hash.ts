 ...
 */
export function generateTemplateHashes(
	rootDir = DEFAULT_ROOT,
): Record<string, string> {
	const templatePath = resolve(rootDir, "shared/templates/view.template.tsx");
	const templateContent = readFileSync(templatePath, "utf-8");

	const themesDir = resolve(rootDir, "public/themes");
...
`;
	...
	console.log("✓ Generated template hashes:", templateHashes);
}
